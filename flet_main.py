...
# <BottomMenuBar> の再現 (ナビゲーションバー)
class BottomMenuBar(ft.Container):
    def __init__(self, current_screen, on_change_screen):
        super().__init__()
        ...
        def make_nav_btn(icon, text, target):
            ...
            return ft.GestureDetector(
                ...
                on_tap=lambda _: on_change_screen(target)  # クリックされたら画面切り替え関数を呼ぶ
            )
